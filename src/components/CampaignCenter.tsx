...
export default function CampaignCenter({ campaigns, onAddCampaign, userRole }: CampaignCenterProps) {
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="bg-[#1F1830] border border-[#7C3AED]/35 p-6 rounded-2xl space-y-4 shadow-xl relative animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="text-[10px] text-gray-400 font-mono">Budget Allocated ($)</label>
              <input
                type="number"
                required
                value={budget}
            ...
            <div className="space-y-1">
              <label className="text-[10px] text-gray-400 font-mono">Starting Expense Spent ($)</label>
              <input
                type="number"
                required
                value={spent}
                ...
                <div key={camp.id} className="bg-[#1F1830] border border-white/5 rounded-2xl p-5 space-y-4 flex flex-col justify-between hover:border-[#7C3AED]/20 transition-all duration-300">
                  ...
                  <div className="space-y-2.5 pt-1">
                    <div className="flex justify-between items-center text-[11px]">
                      ...
                      <strong className="text-white font-mono">${costPerLead} CPL</strong>
                    </div>
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-[10px] font-mono">
                        ...
                        <span className={isOverspent ? "text-rose-400" : "text-[#C084FC]"}>
                          ${camp.spent.toLocaleString()} / ${camp.budget.toLocaleString()} ({capPct}%)
                        </span>
                      </div>
        ...
        <div className="lg:col-span-4 bg-[#1F1830] border border-white/5 rounded-2xl p-6 space-y-5 shadow-xl h-fit">
          ...
          <div className="space-y-3 pt-1">
            <div className="space-y-1">
              <div className="flex justify-between text-[11px] font-mono">
                ...
                <span className="text-[#C084FC] font-semibold">${planAdSpend.toLocaleString()}</span>
              </div>
              <input
                type="range"
                min="1000"
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-[11px] font-mono">
                ...
                <span className="text-[#C084FC] font-semibold">${planCPA}</span>
              </div>
              <input
                type="range"
                min="100"
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-[11px] font-mono">
                ...
                <span className="text-[#C084FC] font-semibold">${planLTV.toLocaleString()}</span>
              </div>
              <input
                type="range"
                min="1000"
          ...
          <div className="bg-[#0D0B14]/90 p-4 rounded-xl border border-white/5 space-y-3 font-mono text-[10px]">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-white font-semibold">${Math.round(planRevenueProj).toLocaleString()}</span>
            </div>
