...
export default function AnalyticsEngine({ leads, campaigns, formatCurrency }: AnalyticsEngineProps) {
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-[#1F1830] border border-white/5 rounded-2xl p-6 space-y-4 shadow-xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <span className="text-base font-bold font-display text-[#C084FC]" id="clv-val">
                  {format(Math.round(estimatedCLV))}
                </span>
            ...
            <p className="text-[10px] text-[#94A3B8]/90 leading-relaxed font-mono bg-[#161122]/40 p-2 rounded-lg border border-white/5">
              CLV Equation: Avg Value x Repeat Factor x Retention Tenure. Total active sandbox value portfolio evaluates as <strong className="text-white">{format(totalValue)}</strong>.
            </p>
          </div>
