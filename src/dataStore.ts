...
export const defaultLeads: Lead[] = [
  ...
  },
  {
    id: "lead-9",
    name: "Liam Chen",
    company: "Trendy Byte Shop",
    email: "liam@trendybyte.io",
    ...
    notes: "Sourced through TikTok short-form analytics campaign. Highly interested in e-commerce drop-off visualizations."
  },
  {
    id: "lead-10",
    name: "Sophia Rodriguez",
    company: "Urban Chic Retail",
    email: "sophia@urbanchic.com",
    ...
    notes: "Acquired via Facebook Lead Form. Looking to unify marketing tracking and CRM stages."
  },
  {
    id: "lead-11",
    name: "Chloe Henderson",
    company: "Luxe Digital Designs",
    email: "chloe@luxedesign.co",
    ...
    notes: "Direct message inbound. Sourced from Instagram portfolio spotlight on Ma Creatives branding."
  },
  {
    id: "lead-12",
    name: "Zack Peterson",
    company: "SaaS Dev Hub",
    email: "zack@saasdevhub.net",
    ...
    notes: "Watched YouTube analytics deep-dive video. Wants custom dashboards for high-throughput pipeline."
  },
  {
    id: "lead-13",
    name: "Aris Thorne",
    company: "AI Builders LLC",
    email: "aris@aibuilders.tech",
    phone: "+1 (555) 674-9011",
    value: 34000,
    stage: FunnelStage.NEGOTIATION,
    ...
    notes: "Engaged via Twitter/X developer thread on predictive sales analytics. Reviewing proposal SOW."
  }
];
